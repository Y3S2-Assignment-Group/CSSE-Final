...
class PlaceeOrderScreen2 extends StatefulWidget {
  const PlaceeOrderScreen2({Key? key}) : super(key: key);

  @override
  _PlaceeOrderScreen2State createState() => _PlaceeOrderScreen2State();
}

class _PlaceeOrderScreen2State extends State<PlaceeOrderScreen2> {
                        ...
                        Row(
                          children: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                context.read<Orderprovider>().confirmOrder();
